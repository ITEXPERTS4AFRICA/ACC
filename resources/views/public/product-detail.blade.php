...
<section class="bg-cover bg-center py-32" style="background-image: url('{{ $page['products']->hero_image ? asset("storage/".$page['products']->hero_image) : asset('images/products/hero-products.png') }}')">

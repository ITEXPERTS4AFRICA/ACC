...
@php
    ...
    $card1    = $articles->get(1);
    $card2    = $articles->get(2);
    $card3    = $articles->get(3);
    $bottom   = $articles->slice(4, 3);
@endphp
...
<section class="relative h-[480px] overflow-hidden bg-dark flex items-center justify-center">
    ...
    @else
        <img src="{{ asset('images/news/hero-news.png') }}" alt="News Hero"
               ...
               class="block border border-gray-200 rounded-sm overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <span class="text-navy text-[10px] font-bold uppercase tracking-widest inline-flex items-center gap-1.5 hover:text-amber transition">
                        {{ app()->getLocale() === 'fr' ? 'Découvrir' : 'Read More' }}
...
<section class="py-20 bg-slate">
    <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative rounded-sm overflow-hidden aspect-[4/3] bg-dark/40">
            <img src="{{ asset('images/news/kit-news.png') }}" alt="Media Kit" class="w-full h-full object-cover">

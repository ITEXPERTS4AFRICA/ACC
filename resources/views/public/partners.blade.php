...
{{-- HERO --}}
<section class="relative h-[440px] flex items-end bg-cover bg-center" style="background-image: url('{{ $page['partners']->hero_image ? asset("storage/".$page['partners']->hero_image) : asset("images/partners/hero-partners.png") }}')">

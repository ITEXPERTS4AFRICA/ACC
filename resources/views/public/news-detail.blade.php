...
<section class="bg-cover bg-center py-32" style="background-image:url('{{ $page['news']->hero_image ? asset("storage/".$page['news']->hero_image) : asset('images/news/card-news-1.png') }}')" >

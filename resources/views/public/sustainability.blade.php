...
{{-- HERO --}}
<section class="relative h-[460px] flex items-end bg-cover overflow-hidden" style="background-image: url('{{ $page['sustainability']->hero_image ? asset("storage/".$page['sustainability']->hero_image) : asset("images/sustainability/hero-sustainability.png") }}')">

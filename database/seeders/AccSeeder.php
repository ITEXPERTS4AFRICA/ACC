...
class AccSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $factories = [
            [
                'name' => 'Usine d\'Abidjan',
                'name_en' => 'Abidjan Plant',
                'city' => 'Abidjan',
                'country' => 'Côte d\'Ivoire',
                'capacity_mt' => 60000,
                'status' => 'operational',
                'order' => 1,
                'image' => 'factories/klKwcaG4sGGXW2X4BZIOiENZHfNHLZx5fMNyKG4k.jpg',
            ...
            [
                'name' => 'Usine de San Pedro',
                'name_en' => 'San Pedro Plant',
                'city' => 'San Pedro',
                'country' => 'Côte d\'Ivoire',
                'capacity_mt' => 60000,
                'status' => 'operational',
                'order' => 2,
                'image' => 'factories/kNC9dOPNezb9nTyrlcJTdDoS1DWxBPNzN1cyKEoL.jpg',
            ...
            [
                ...
                'status' => 'construction',
                'order' => 3,
                'image' => 'factories/PQIcskPlsR75qOLnlEViGsfcRiXYGrYG4ASd3ehh.jpg',
        ...
        foreach ($factories as $f) {
            Factory::firstOrCreate(['city' => $f['city'], 'country' => $f['country']], $f + ['active' => true]);
        }
        ...
        $products = [
            [
                'name' => 'Masse de Cacao',
                'name_en' => 'Cocoa Liquor',
                'slug' => 'masse-de-cacao',
                'order' => 1,
                'image' => 'products/UxlUEGLrlUNddarxdB7NgGLZgyl4g6rS99Sv2bY4.jpg',
            ...
            [
                ...
                'order' => 2,
                'image' => 'products/vfR9M01Ws9HAI0MYhLjgYRYRuJOy4XO0fcDPaiV5.jpg',
            ...
            [
                'name' => 'Tourteaux de Cacao',
                'name_en' => 'Cocoa Cake',
                'slug' => 'tourteaux-de-cacao',
                'order' => 3,
        ...
        foreach ($products as $p) {
            Product::firstOrCreate(['slug' => $p['slug']], $p + ['active' => true]);
        }

        // Certifications
        $certifications = [
            ['name' => 'FSSC 22000', 'logo' => 'certifications/drEsTicv7Dtz6iHHfM1qByCCVSA2JutTpXgfEA01.png', 'description' => 'Certification internationale de sécurité alimentaire, référentiel GFSI.', 'description_en' => 'International food safety certification, GFSI benchmarked.', 'order' => 1],
            ['name' => 'ISO 9001:2015', 'logo' => 'certifications/HozEHZlXCDMS6kPJYY7W3g4ytpPo0p4lKPBg4W6o.png', 'description' => 'Système de management de la qualité ISO.', 'description_en' => 'ISO quality management system.', 'order' => 2],
            ['name' => 'Rainforest Alliance', 'logo' => 'certifications/IjRkQOFYAWku52gF3S3WoSZv7FjgJOsTbjpSyFd8.png', 'description' => 'Certification de durabilité pour un approvisionnement responsable.', 'description_en' => 'Sustainability certification for responsible sourcing.', 'order' => 3],
            ['name' => 'UTZ Certified', 'logo' => 'certifications/Savh3ApkgjtVmoC7Hwlu6L5LFMhvpuazOmpAXnYp.png', 'description' => 'Programme pour une agriculture durable et responsable.', 'description_en' => 'Program for sustainable and responsible farming.', 'order' => 4],
            ['name' => 'Fair Trade', 'logo' => 'certifications/ZBS1mBf5FtuSpsplH1HlaggTXxMZOE8HcHoCltbE.png', 'description' => 'Commerce équitable garantissant des conditions justes pour les producteurs.', 'description_en' => 'Fair trade ensuring fair conditions for producers.', 'order' => 5],
        ...
        foreach ($certifications as $c) {
            Certification::firstOrCreate(['name' => $c['name']], $c + ['active' => true]);
        }
        ...
        $pillars = [
            ...
            [
                ...
                'title_en' => 'Governance & transparency',
                'icon' => '📋',
                'order' => 4,
        ...
        foreach ($pillars as $p) {
            RsePillar::firstOrCreate(['title' => $p['title']], $p);
        }
        ...
        $pages = [
            [
                'page_key' => 'home',
                'meta_title' => 'Atlantic Cocoa Corporation – Leader en transformation de cacao',
                'meta_title_en' => 'Atlantic Cocoa Corporation – Leading Cocoa Processor',
            ...
            [
                'page_key' => 'about',
                'meta_title' => 'À propos d\'ACC – Notre histoire et nos valeurs',
                'meta_title_en' => 'About ACC – Our History and Values',
            ...
            [
                'page_key' => 'products',
                'meta_title' => 'Nos Produits – Masse, Beurre, Tourteaux, Poudre de Cacao | ACC',
                'meta_title_en' => 'Our Products – Cocoa Mass, Butter, Cake, Powder | ACC',
            ...
            [
                'page_key' => 'quality',
                'meta_title' => 'Qualité & Certifications | ACC',
                'meta_title_en' => 'Quality & Certifications | ACC',
            ...
            [
                'page_key' => 'contact',
                'meta_title' => 'Contact | Atlantic Cocoa Corporation',
                'meta_title_en' => 'Contact | Atlantic Cocoa Corporation',
        ...
        foreach ($pages as $p) {
            SeoSetting::firstOrCreate(['page_key' => $p['page_key']], $p);
        }
    }
}
